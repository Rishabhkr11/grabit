...
class _LoginState extends State<Login>
{
  ...
  void loginUser() async
  {
    showDialog(
      ...
      builder: (c)
      {
        return LoadingAlertDialog(message: "Verifying your credentials, Please wait...",);
      }
    );
